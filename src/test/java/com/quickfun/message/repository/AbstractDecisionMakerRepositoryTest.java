...
public class AbstractDecisionMakerRepositoryTest {
    ...
    @Test
    public void should_retrieve_entity_from_database_with_an_id() throws DecisionMakerException {
            // Given
            Long target = 1L;
            DummyObject dummyObject = new DummyObject();
    ...
    public void should_retrieve_entity_from_database_that_doesnt_exist() throws DecisionMakerException {
            // Given
            Long target = 1L;
            List<DummyObject> mockResults = mock(List.class);
            Criteria mockCriteria = mock(Criteria.class);
    ...
    @Test(expected = DecisionMakerException.class)
    public void should_throw_decision_exception_error_when_deleting_a_fake_id() throws DecisionMakerException {
            // Given
            Criteria mockCriteria = mock(Criteria.class);
    ...
    @Test
    public void should_delete_five_rows_from_table() throws DecisionMakerException {
            // Given
            DummyObject obj = new DummyObject();
            Criteria mockCriteria = mock(Criteria.class);
            List<DummyObject> mockResults = new ArrayList<DummyObject>();
